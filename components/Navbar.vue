...
<template>
    <header class="bg-white">
      <nav class="mx-auto flex max-w-7xl items-center justify-between gap-x-6 p-6 lg:px-8" aria-label="Global">
        ...
        <div class="flex flex-1 items-center justify-end gap-x-6"  v-if="!isAuthenticated">
          <nuxt-link to="/auth/login" class="hidden lg:block lg:text-sm lg:font-semibold lg:leading-6 lg:text-gray-900">Log in</nuxt-link>
        ...
        <div class="flex flex-1 items-center justify-end gap-x-6"  v-if="isAuthenticated">
          ...
          <nuxt-link to="/dashboard" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Dashboard</nuxt-link>
        </div>
